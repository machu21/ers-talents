...
export default function Hero({
  ...
  return (
    <header className="max-w-[1440px] mx-auto px-6 flex flex-col items-center text-center pt-16 pb-12">
      ...
      <p className="text-lg text-slate-500 max-w-xl mt-2 leading-relaxed">
      ...
      {/* Filter tabs */}
      <div
        className="flex gap-2 mt-10 p-1.5 rounded-full bg-white border border-slate-200/80 shadow-sm"
        role="tablist"
